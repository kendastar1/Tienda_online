...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        if (!empty($row['imagen'])) {
            ...
            $row['imagen'] = 'https://via.placeholder.com/300x400?text=Calzado+No+Disponible';
        }
        $products[] = $row;
    }
}
